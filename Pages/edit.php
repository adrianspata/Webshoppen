        ...
        <div class="container px-4 px-lg-5 mt-5">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                        class="form-control <?php echo $v->get_error_message('price') != "" ? "is-invalid" : "" ?>"" name="
                        price" value="<?php echo $product->price ?>">
                    <span class="invalid-feedback"><?php echo $v->get_error_message('price'); ?></span>
                </div>
                <div class="form-group">
                    <label for="stockLevel">Stock</label>
                    <input type="text"
                        class="form-control <?php echo $v->get_error_message('stockLevel') != "" ? "is-invalid" : "" ?>"" name="
                        stockLevel" value="<?php echo $product->stockLevel ?>">
                    <span class="invalid-feedback"><?php echo $v->get_error_message('stockLevel'); ?></span>
                </div>
                <div class="form-group">
                    <label for="categoryName">Category name:</label>
                    <input type="text"
                        class="form-control <?php echo $v->get_error_message('categoryName') != "" ? "is-invalid" : "" ?>"" name="
                        categoryName" value="<?php echo $product->categoryName ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number"
                        class="form-control <?php echo $v->get_error_message('popularityFactor') != "" ? "is-invalid" : "" ?>"" name="
                        popularityFactor" value="<?php echo $product->popularityFactor ?>">
